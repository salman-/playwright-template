...
async function addNewItemToList(page: Page, item: string) {
...
test.describe('New Todo', () => {
  test('should allow me to add todo items', async ({page}) => {
    ...
    await addNewItemToList(page, TODO_ITEMS[0]);
    await verifyItemsOnList(page, [TODO_ITEMS[0]]);

    // When: A new item is added to the list
    await addNewItemToList(page, TODO_ITEMS[1]);

    // Then: There are 2 items on list
    await verifyItemsOnList(page, [TODO_ITEMS[0], TODO_ITEMS[1]]);
  });
});
